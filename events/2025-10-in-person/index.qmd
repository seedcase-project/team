...
-   **Luke**: High level introduction to [Rust](https://www.rust-lang.org/),
    mainly to share some features, benefits, and simple examples of some code.
...
Later in the session, I might show how it might look in a stricter,
more advanced language like Rust.
