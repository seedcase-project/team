...
-   **Luke**: High level introduction to
    ...
    benefits, and simple examples of some code. Will walk through my
...
-   We also would like to spend some time in developing educational
    resources, though we aren't sure how much to prioritise this right
    now.
...
-   We learned a lot more about what Steno Aarhus aims to do with the
    ...
    better understanding how the "meta" register project that Marie
