...
- **Main aims**:
  - Understand each other on more personal levels (related to work and
    Seedcase).
  - Not to focus too much on technical aspects, but more on human and
    social aspects.
  - Become informed about other projects that we might collaborate with
...
- It seems like there is a bit of a drift in understanding of what we're
  doing, why, and how. So this is some dedicated time to assess how we
  all understand things and take some time to update and discuss it.
- Discuss and brainstorm how Seedcase will look like in the end and how
  users might interact with it.
...
- Write out and share how we each would like to see Seedcase develop in
  the next few years *and* what we would like to work on over that time.
...
- How does the progress and current status, as well as the challenges
  and barriers, align with the goals and perspectives we just discussed?
...
- Status update to Annelli:
  ...
  - Share how we intend to showcase our work to people (e.g. with data
    showcases and guide).
  - Any future plans (collaboration projects).
- Presentations on ON-LiMiT and DP-Next projects:
  - **Aim**: Learn about new projects, what their needs are, and how we
    can contribute.
  - ON-LiMiT by Daniel Ibsen (\~15 min).
  - [DP-Next](https://dp-next.github.io/) by Daniel Witte (\~15 min).
...
building towards. Then agreeing on what we each individually wanted to
be doing and working on. In the end, we all felt more aligned and
understood each other better.

#### Signe

- Develop in Python more
- Expand on *software design* skills, such as what functionality is
  needed, how can it be designed, etc.? Learn about best
...
- The problem domain is generally very interesting! :+1:
...
- More courses!
- Would love to hire more people (for documentation+training side of
  things)
...
We trimmed down many of the potential deliverables to ones we wanted to
work on, moved several into "potential/interested" and kept only a few
in "will do" or "doing" categories. We also went over and agreed that
more detailed roadmaps would be on the GitHub Project [Long-term
...
informative. Since they both are early in their development, we don't
have any tangible actions, expectations, or deliverables yet. But we do
plan on collaborating and revisiting these discussions in future
meetings.
