...
-   Pivot to focus on *usage* of Sprout and user documentation / user
    side
...
-   Learn more about the researchers themselves (when they start using
    it)
...
-   Would love to hire more people (for documentation+training side of
    things)
-   Work with more people who are excited to use this stuff that we
    build
...
have an tangible actions, expectations, or deliverables yet. But we do
plan on collaborating together and to revisit these discussions in
future meetings.
