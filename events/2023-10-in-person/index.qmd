...
- Hiring them and what/how they can work with us
    ...
    - [X] Action: To contact them about hiring them, what are the next steps? How them charge
...
- Things we could take from them
    - Their approach to visualizing things (e.g. for instance with the vertical lines)
        - For virtual settings: Look into online tools that help with doing the visualize
...
- Moving forward, tracking progress, and building trust
    ...
    - Make use of Issue’s
        ...
        - [ ] Action: Richard make the first draft of template
    - Make a PR template
    ...
    - Annelli will attend an update meeting on
- Tasks to do next
    - Converting over the digital copies and updating documentation
        - [ ] Action: Signe and Kris will convert
    ...
    - Build up Actions/CI
    - Pre-commits setup
    - Basic infrastructure for working together
    - Make issue template that includes a very detailed requirements for functionality (including input and output of functions/code)
    - Review process?
        - PR
- Misc items
