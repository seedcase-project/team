...
daily, we have them twice-weekly. These are some guidelines on running
...
-   Once a week (usually on Thursdays) during an update meeting, we'll
    internally do a demo of the current state of the project, either
