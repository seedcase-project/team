...
iteration, individual team members self-assign themselves on these
unassigned issues that they would like to work on. Here are some
...
-   Only one person (in general) should be assigned per issue, so that
    ...
    someone who is responsible for them. However, anyone can help with
    the issue though.
...
In general, we limit meetings as much as is necessary, however some can
...
-   Plan meetings on knowledge sharing or for code reviewing when, for
    ...
    request, they will need to do a bit of preparation before hand for
