...
You also need to tell Git that the LFS store is safe:

```bash
git config --global --add safe.directory /faststorage/project/sdca-onlimit-study/feasibility-data-lfs-store
```
