...
Any changes made (e.g., editing files, or checking out to a different branch) in
the shared repository will be visible for all users. So, to avoid us working in
the same local repository on GenomeDK, we each create a clone in our own user
