...
- Limit meetings as much as is necessary, excluding our
  [weekly update](update-meetings.qmd) meetings
  - Hold a meeting if we require a more active and dynamic discussion
    and eventual decision on something
...
- Limit emails as much as is necessary, unless communication is with
  someone external to our team or requires a more formal written record
...
- Use a GitHub Issue for longer discussions that require more thought
  and consideration from other team members and that are tied to a more
