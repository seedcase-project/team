...
2. Check that it says "seedcase-debugger" in the top, next to the "Play"
   icon button (don't click it yet, if you want to add break points)
...
4. Then, in the "Run and debug" tab, click "Play". The debug console
   ...
   `just start-app`) and go to the page you want to debug. The code will
   stop at your break point(s) and you can inspect the variables at that
   stage in the tab.
