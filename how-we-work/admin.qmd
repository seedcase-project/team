...
This way, we ensure that the changes are made in each release can be
easily traced.
...
-   **Rebase:** Build, chore, and sync

-   **Merge:** Non-atomic/other PRs

With atomic PRs, we mean PRs that only include "self-contained changes"
