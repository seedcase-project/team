...
- Use Ruff as well as VSCode "checker" (should work automatically) to check that the format of code is written correctly by follow the styling instructions. For instance:
    - Write docstrings for every function, class, and method.
    - Include type hints and return hints.
