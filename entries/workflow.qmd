...
up to install when you're using VS code to edit any of the Seedcase GitHub
...
-   Follow the steps that appear to write a conventional commit
    message. The extension will provide auto-completion for the type of
    commit message, and it will help you write a message that
